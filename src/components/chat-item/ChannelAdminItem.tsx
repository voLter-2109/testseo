...
const ChannelAdminItem = () => {
  ...
  return (
    <div ref={chatItemRef}>
      <NavLink
        to="944d1dae-4d38-4c3b-b010-2b70ad7m7i7n"
      ...
      >
        ...
        <div className={style.content}>
          <h3 className={style.name} title="Канал (админ)">
            Админ видит этот канал
          </h3>
...
export default memo(ChannelAdminItem);
